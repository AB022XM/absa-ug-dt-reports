...
To build the final jar and optimize the AbsaUGDTReports application for production, run:
...
Then navigate to [http://localhost:1710](http://localhost:1710) in your browser.
